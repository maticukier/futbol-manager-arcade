...
import { clubPorId, partidoDelUsuario, plantelDe } from '@/sim/juego';
  ...
  return `
    ...
    <div class="grilla-2">
      <div class="tarjeta">
        ...
        <div class="suave" style="font-size:12px">${fila?.pts ?? 0} pts · fecha ${estado.jornadaActual} de ${totalJornadas(estado.fixture)}</div>
      </div>
      <div class="tarjeta">
